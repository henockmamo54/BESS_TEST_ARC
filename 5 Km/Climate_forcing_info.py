...
class Climate_forcing_info:
    ...
    def generate_all_climate_forcing_info_monthly(self,year,month): 

        print("generate_all_climate_forcing_info_monthly\n","====><><><><><====== \n", year, month)      
        ...
        try:
            print("1. f_ERA")
            eng.f_ERA(year,month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
            
        try:
            print("2. f_DownscaleERA5Daily")
            eng.f_DownscaleERA5Daily(year,
                                           month,'Ta',nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            ...
            eng.f_DownscaleERA5Snapshot(year,
                                              month,'Ta','MOD',nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            ...
            eng.f_DownscaleERA5Snapshot(year,
                                              month,'Td','MYD',nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
            
        try:
            print("10. f_RadiationERA")
            eng.f_RadiationERA(year,month,'AM',nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
            
        try:
            print("11. f_RadiationERA")
            eng.f_RadiationERA(year,
                                      month,'PM',nargout=0)        
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            ...
            eng.f_RadiationFill('Rg_AM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            ...
            eng.f_RadiationFill('Rg_PM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            ...
            eng.f_RadiationFill('UV_AM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("16. ")
            eng.f_RadiationFill('UV_PM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("17. ")
            eng.f_RadiationFill('PARDir_AM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("18. ")
            eng.f_RadiationFill('PARDir_PM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("19. ")
            eng.f_RadiationFill('PARDiff_AM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("20. ")
            eng.f_RadiationFill('PARDiff_PM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("21. ")
            eng.f_RadiationFill('NIRDir_AM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("22. ")
            eng.f_RadiationFill('NIRDir_PM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("23. ")
            eng.f_RadiationFill('NIRDiff_AM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("24. ")
            eng.f_RadiationFill('NIRDiff_PM',year,
                                      month,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("28. ")		 
            eng.f_AverageMonthly('Rs_AM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("29. ")						  
            eng.f_AverageMonthly('Rs_PM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("30. ")						  
            eng.f_AverageMonthly('UV_ERA_AM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("31. ")						  
            eng.f_AverageMonthly('UV_ERA_PM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("32. ")						  
            eng.f_AverageMonthly('PARDir_ERA_AM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("33. ")						  
            eng.f_AverageMonthly('PARDir_ERA_PM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try: 
            print("34. ")
            eng.f_AverageMonthly('PARDiff_ERA_AM',year, 
                                       month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("35. ")						  
            eng.f_AverageMonthly('PARDiff_ERA_PM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("36")
            eng.f_AverageMonthly('NIRDir_ERA_AM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("37")						  
            eng.f_AverageMonthly('NIRDir_ERA_PM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        try:
            print("38")							  
            eng.f_AverageMonthly('NIRDiff_ERA_AM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            print("39")						  
            eng.f_AverageMonthly('NIRDiff_ERA_PM',year,
                                      month,0,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        ...
        try:
            ...
            eng.f_OCO2(year, month,nargout=0)        
        except:
            print("Unexpected error:", sys.exc_info()[0])
        
        # we don't have values for years after 2019
        # try:
            # print("41")
            # eng.f_NOAAbaseline(year, month,nargout=0)        
        # except:
            # print("Unexpected error:", sys.exc_info()[0])
        
        try:
            print("42")
            eng.f_Ca_(year, month,nargout=0) 
        except:
            print("Unexpected error:", sys.exc_info()[0])
                
        try:
            print("43 f_FNonVeg")
            eng.f_FNonVeg(year ,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
        
        try:
            print("43 f_Vcmax25")
            eng.f_Vcmax25(year, month ,nargout=0)
        except:
            print("Unexpected error:", sys.exc_info()[0])
    ...
    def generate_all_climate_forcing_info_yearly(self,year) :
        
        for i in range(12):
            i=i+1
            print(i)
            self.generate_all_climate_forcing_info_monthly(year,i)  
    ...
    def generate_all_climate_forcing_info(self):
        ...
        try:
            print("41")
            #we don't co2 values straing from 2020-01-01
            #eng.f_NOAAbaseline(self._bessObject.Year, self._bessObject.Month,nargout=0)        
        except:
            print("Unexpected error:", sys.exc_info()[0])
