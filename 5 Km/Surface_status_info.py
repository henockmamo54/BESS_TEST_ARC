...
class Surface_status_info:
    ...
    def generate_all_surface_info_yearly(self,year) :
        ...
        for index in range(1,13):        
            try:
                print("6")
                eng.f_AverageMonthly('RVIS_MCD^',years[int(index/12)],months[index]
                                     ,0,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):
            try:
                print("7")
                eng.f_AverageMonthly('RNIR_MCD^',years[int(index/12)], months[index],0,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):    
            try:
                eng.f_AverageMonthly("RSW_MCD^",years[int(index/12)],
        ...
        for index in range(1,13):
            try:
                print("8")
                eng.f_AverageMonthly("NDVI_MCD^",years[int(index/12)],
                                        months[index],0,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):
            try:
                eng.f_AverageMonthly("EMIS_MCD^",years[int(index/12)],
                                    months[index],0,nargout=0)                                        
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):                               
            try:
                print("9")
                eng.f_VariationMonthly("RVIS_MCD^",years[int(index/12)],
                                        months[index],0,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):
            try:         
                eng.f_VariationMonthly("RNIR_MCD^",years[int(index/12)],
                                    months[index],0,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):    
            try:
                print("10")
                eng.f_VariationMonthly("RSW_MCD^",years[int(index/12)],
                                        months[index],0,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):
            try:
                print("11")
                eng.f_VariationMonthly("NDVI_MCD^",years[int(index/12)],
                                        months[index],0,nargout=0)  
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):    
            try:    
                print("12")
                eng.f_VariationMonthly("EMIS_MCD^",years[int(index/12)],
                                        months[index],0,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):
            try:
                print("24")
                eng.f_AverageMonthly('LAI_MCD_Filter^', years[int(index/12)],
                                        months[index],0,nargout=0)  
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue    
        ...
        for index in range(1,13):
            try:
                print("25")
                eng.f_AverageMonthly('FPAR_MCD_Filter^', years[int(index/12)],
                                        months[index],0,nargout=0)  
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):
            try:            
                print("26")
                eng.f_VariationMonthly('LAI_MCD_Filter^', years[int(index/12)],
                                        months[index],0,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):
            try:
                print("27")
                eng.f_VariationMonthly('FPAR_MCD_Filter^', years[int(index/12)],
                                        months[index],0,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):
            try:
                print("31")
                eng.f_AverageMonthly('LAI_MOD_Filter^', years[int(index/12)],
        ...
        for index in range(1,13):
            try:
                print("32")
                eng.f_AverageMonthly('FPAR_MOD_Filter^', years[int(index/12)],
                                        months[index],2,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):    
            try:
                print("33")
                eng.f_VariationMonthly('LAI_MOD_Filter^', years[int(index/12)],
                                        months[index],2,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
        ...
        for index in range(1,13):    
            try:
                print("34")					  
                eng.f_VariationMonthly('FPAR_MOD_Filter^', years[int(index/12)],
                                        months[index],2,nargout=0) 
            except:
                print("Unexpected error:", sys.exc_info()[0])
                continue
